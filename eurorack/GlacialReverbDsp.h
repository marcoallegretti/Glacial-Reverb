...
class GlacialReverbDsp
{

/*\\ PUBLIC \\\\*/

public:
   GlacialReverbDsp (float sample_freq);
   ~GlacialReverbDsp ();
...
private:
   ...
   GlacialReverbDsp & operator = (const GlacialReverbDsp & rhs) = delete;
   GlacialReverbDsp & operator = (GlacialReverbDsp && rhs) = delete;
};

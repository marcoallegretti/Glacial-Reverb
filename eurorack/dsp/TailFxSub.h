...
class TailFxSub : public TailFx
{
public:
   explicit       TailFxSub (float sample_freq);
...
inline TailFxSub::TailFxSub (float sample_freq)
:  _sr (sample_freq)

...
private:
   ...
   static constexpr std::size_t max_time_spl
      = 4127 + std::size_t (max_sample_freq * 0.0017f) + 17 /* 16.5 */;
   static constexpr std::size_t nbr_delays = 8;

   struct DelayLine
   {
      std::array <float, max_time_spl> buf = {};
   };
   ...
   static constexpr float _junction_pressure_scale = 0.25f;
   static constexpr float _output_gain = 0.35f;
   static const Params    _params [nbr_delays];
